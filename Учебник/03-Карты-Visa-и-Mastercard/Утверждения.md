...
- Ссылка вида `S001: §…` в evidence означает `P03-S001 + snapshot_id P03-S001@2026-09-15 + locator + relation=supports`. `context`/`contradicts` указаны отдельно. Название и URL раскрыты в [Источники](Источники.md); ближайшая ссылка в [CHAPTER.md](README.md) ведет напрямую в оригинал.
