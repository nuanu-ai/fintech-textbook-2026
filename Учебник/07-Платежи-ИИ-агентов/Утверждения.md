...
- **evidence / locator / relation / reasoning:**
  - [P07-S001](Источники.md#p07-s001) / `P07-S001-20260915`; §15.5.3; `supports`: Нормативное значение кода ограничено reserved for future use.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S002](Источники.md#p07-s002) / `P07-S002-20260915`; §§6–7 flows; `context`: Различные последовательности обработки x402.
  - [P07-S014](Источники.md#p07-s014) / `P07-S014-20260915`; Status Lifecycle Values; `context`: Checkout status отражает собственный lifecycle.
  - [P07-S040](Источники.md#p07-s040) / `P07-S040-20260915`; status; `context`: PaymentIntent имеет отдельные платежные состояния.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S026](Источники.md#p07-s026) / `P07-S026-20260915`; Disclaimer; How does it work?; Controls; `supports`: Есть оговорка о разработке и изменении доступности.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S027](Источники.md#p07-s027) / `P07-S027-20260915`; Introduction; Participants; Trust Model; Agent Recognition; `supports`: Роли и проверка trusted agent описаны самим владельцем протокола.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S028](Источники.md#p07-s028) / `P07-S028-20260915`; Main announcement; pilot description; `supports`: Пилотный scope сохранен в формулировке.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S029](Источники.md#p07-s029) / `P07-S029-20260915`; Framework; agent registration; tokenization; contextual data; `supports`: Публично описанный подход компании.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S030](Источники.md#p07-s030) / `P07-S030-20260915`; Headline; How it works; Partnering; `supports`: Подтверждает анонс и описанную цепочку партнеров.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S022](Источники.md#p07-s022) / `P07-S022-20260915`; Sellers: How it works; restrictions; using a token; `supports`: SPT передает ограниченную платежную возможность.
  - [P07-S040](Источники.md#p07-s040) / `P07-S040-20260915`; status; `context`: PaymentIntent отражает дальнейший результат.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S024](Источники.md#p07-s024) / `P07-S024-20260915`; Agents — Private preview; `supports`: Статус прочитан вместе с заголовком соответствующего раздела.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S010](Источники.md#p07-s010) / `P07-S010-20260915`; README status/versioning; CHANGELOG; `supports`: Репозиторий различает опубликованную версию и текущую работу.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S011](Источники.md#p07-s011) / `P07-S011-20260915`; checkout session operations and schema; `supports`: Операции управляют checkout.
  - [P07-S012](Источники.md#p07-s012) / `P07-S012-20260915`; POST /agentic_commerce/delegate_payment; Allowance; `supports`: Описан отдельный allowance/token flow.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S012](Источники.md#p07-s012) / `P07-S012-20260915`; Allowance, lines 520–559; IdempotencyKeyHeader, lines 251–255; `supports`: Поля и header прочитаны в схеме.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S025](Источники.md#p07-s025) / `P07-S025-20260915`; Approved partners; product feeds; onboarding; `supports`: Документация описывает отбор и отдельный onboarding.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S003](Источники.md#p07-s003) / `P07-S003-20260915`; Payment Required; Payment Payload; Payment Response; `supports`: Форматы заголовков определены в transport.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S002](Источники.md#p07-s002) / `P07-S002-20260915`; Facilitator API /verify and /settle; `supports`: Контракт содержит разные операции.
  - [P07-S004](Источники.md#p07-s004) / `P07-S004-20260915`; EIP-3009 phases 2 and 3; `supports`: Проверка и отправка разделены.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S002](Источники.md#p07-s002) / `P07-S002-20260915`; Authorization/Upfront/Escrow execution flow; `supports`: В документе представлены разные последовательности.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S004](Источники.md#p07-s004) / `P07-S004-20260915`; PaymentPayload; authorization fields; verify/settle phases; `supports`: Подписываемые transfer поля ограничены данным контрактом.
  - [P07-S005](Источники.md#p07-s005) / `P07-S005-20260915`; Purpose; Specification; `context`: Отдельная extension вводит application payment identifier.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S005](Источники.md#p07-s005) / `P07-S005-20260915`; Purpose; Requirements; Example flow; `supports`: Extension описывает сохранение/повторное предъявление ID.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S006](Источники.md#p07-s006) / `P07-S006-20260915`; Document metadata; Status of This Memo; `supports`: Статус и сроки доступны в опубликованном draft.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S006](Источники.md#p07-s006) / `P07-S006-20260915`; Payment Challenges; Payment Credentials; header selection; `supports`: Протокол разделяет действие и метод его исполнения.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S007](Источники.md#p07-s007) / `P07-S007-20260915`; Overview; Flow; Payment Processing; `supports`: В описании явно участвуют Stripe token и серверная обработка платежа.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S009](Источники.md#p07-s009) / `P07-S009-20260915`; Abstract; Replay Protection; Pull Mode Settlement; `supports`: Прямо прочитаны обе формы credential и требования replay protection.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S008](Источники.md#p07-s008) / `P07-S008-20260915`; Overview; Session flow; cumulative voucher model; `supports`: Модель разделяет пополнение и накопленный объем требований.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S013](Источники.md#p07-s013) / `P07-S013-20260915`; Overview; Discovery; Capability/Extension Model; `supports`: Описана композиция торговых возможностей.
  - [P07-S015](Источники.md#p07-s015) / `P07-S015-20260915`; Purpose; Participants; Processing; `supports`: Payment handler отвечает за выбранный платежный способ.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S014](Источники.md#p07-s014) / `P07-S014-20260915`; Status Lifecycle Values; Complete checkout; `supports`: Статусы и наличие order различены в контракте.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S014](Источники.md#p07-s014) / `P07-S014-20260915`; Continue URL; requires_escalation; `supports`: Контракт содержит переход к human action.
  - [P07-S016](Источники.md#p07-s016) / `P07-S016-20260915`; Runtime flow and example; `context`: Платежная аутентификация согласуется отдельно.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S023](Источники.md#p07-s023) / `P07-S023-20260915`; Availability; settlement; supported methods; `supports`: Прочитана полная краткая страница, включая US except NY и запрос других регионов.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S023](Источники.md#p07-s023) / `P07-S023-20260915`; Settlement to Stripe balance; `context`: Пример провайдера с отдельным балансом.
  - [P07-S002](Источники.md#p07-s002) / `P07-S002-20260915`; Core scope and participant model; `context`: HTTP/core протокол не устанавливает весь банковский payout.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S037](Источники.md#p07-s037) / `P07-S037-20260915`; Main post; `supports`: Подтверждается факт собственного заявления.
  - [P07-S007](Источники.md#p07-s007) / `P07-S007-20260915`; Stripe charge flow; `contradicts`: Универсальная трактовка несовместима с processor-backed method.
  - [P07-S023](Источники.md#p07-s023) / `P07-S023-20260915`; Machine payments processing; `context`: Пример финансового посредника в реальном product description.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S036](Источники.md#p07-s036) / `P07-S036-20260915`; Main post and visible continuations; `supports`: Автор главы самостоятельно прочитал оригинал через Chrome UI.
  - [P07-S009](Источники.md#p07-s009) / `P07-S009-20260915`; Pinned method specification; `context`: Техническая форма метода подтверждается отдельно.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S038](Источники.md#p07-s038) / `P07-S038-20260915`; Main post, test-mode points 1–4; `supports`: Самоотчет прочитан, код не запускался.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S033](Источники.md#p07-s033) / `P07-S033-20260917`; §§3.4, 4.1–4.3; task/attack construction; `supports`: Прочитаны методы и ограничения оценки, не только abstract.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S034](Источники.md#p07-s034) / `P07-S034-20260915`; §§III–VII; threat model; evaluation; limitations; `supports`: Прочитаны модель, evidence levels и ограничения.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S035](Источники.md#p07-s035) / `P07-S035-20260915`; §§3–9, especially threat model, demos, CDSE, ablations, limitations; `supports`: Изучены экспериментальные условия и границы, не только abstract.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S004](Источники.md#p07-s004) / `P07-S004-20260915`; settlement_pending; transaction and network fields; `context`: Протокол дает устойчивые идентификаторы неопределенного исхода.
  - [P07-S005](Источники.md#p07-s005) / `P07-S005-20260915`; Idempotency requirements; `context`: Повтор должен сохранять связь с прежней операцией.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S004](Источники.md#p07-s004) / `P07-S004-20260915`; Settlement response; settlement_pending; `supports`: Исход обозначен не как финальный fail.
  - [P07-S002](Источники.md#p07-s002) / `P07-S002-20260915`; SettleResponse handling; `context`: Core различает результат settlement.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S020](Источники.md#p07-s020) / `P07-S020-20260915`; Budget/recurrence constraints; `context`: Ограничения требуют учета предыдущих предъявлений.
  - [P07-S021](Источники.md#p07-s021) / `P07-S021-20260915`; Server-side validation and replay considerations; `context`: Проверки должны исполняться на доверенной стороне.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S031](Источники.md#p07-s031) / `P07-S031-20260915`; Scope; Delegation vs. Impersonation; act; `supports`: Trust model и конкретные token security semantics ограничены scope RFC.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S032](Источники.md#p07-s032) / `P07-S032-20260915`; DPoP Proof JWTs; checking proofs; binding access tokens; `supports`: Proof применяется вместе с token и проверками resource server.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S041](Источники.md#p07-s041) / `P07-S041-20260915`; §4.1; §5.2; §7; §8.5; `supports`: Доверяющая сторона применяет политику к результату оценки среды.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S017](Источники.md#p07-s017) / `P07-S017-20260915`; Mandates; Human-present and autonomous flows; CHANGELOG 0.2.0; `supports`: Термины и flows соответствуют указанной версии.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S018](Источники.md#p07-s018) / `P07-S018-20260915`; Introduction; User Credential; Trusted Agent Provider; `supports`: Разные trust arrangements описаны в первичке.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S019](Источники.md#p07-s019) / `P07-S019-20260915`; Usage; Type; Checkout Hash; `supports`: Связь с конкретным checkout задана структурой.
  - [P07-S017](Источники.md#p07-s017) / `P07-S017-20260915`; Autonomous flow; `context`: Closed mandates проверяются относительно согласованных open mandates.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S020](Источники.md#p07-s020) / `P07-S020-20260915`; Constraints; Budget; Recurrence; Allowed Payees/Instruments; `supports`: Прочитан перечень ограничений и условия их проверки.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S019](Источники.md#p07-s019) / `P07-S019-20260915`; Line Items constraint; `supports`: Ограничение указано явно.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S021](Источники.md#p07-s021) / `P07-S021-20260915`; Consent; deterministic verification; Trusted Surface; privacy; `supports`: Полностью прочитанный файл задает границы проверок.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S039](Источники.md#p07-s039) / `P07-S039-20260915`; Publication overview and update warning; `supports`: Полный PDF не прочитан; действующие обязанности по странам не выводятся.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S026](Источники.md#p07-s026) / `P07-S026-20260915`; Public scope/disclaimer; `context`: Overview не заменяет договоры.
  - [P07-S029](Источники.md#p07-s029) / `P07-S029-20260915`; Framework public description; `context`: Не полный rulebook.
  - [P07-S017](Источники.md#p07-s017) / `P07-S017-20260915`; Dispute-resolution scope; `context`: Evidence и dispute mechanism имеют разные scopes.
...
- **evidence / locator / relation / reasoning:**
  - [P07-S002](Источники.md#p07-s002) / `P07-S002-20260915`; Verify/settle and response model; `contradicts`: Authorization и settlement разнесены.
  - [P07-S014](Источники.md#p07-s014) / `P07-S014-20260915`; Checkout lifecycle; `context`: Order и fulfillment также раздельны.
...
- **jurisdiction / conditions:** Универсальное утверждение.
- **evidence / locator / relation / reasoning:**
  - [P07-S018](Источники.md#p07-s018) / `P07-S018-20260915`; Agent Authorization; `contradicts`: Требуется отдельная модель согласия.
  - [P07-S031](Источники.md#p07-s031) / `P07-S031-20260915`; Trust-model scope; delegation semantics; `contradicts`: Структура actor/subject не задает все права.
  - [P07-S032](Источники.md#p07-s032) / `P07-S032-20260915`; Proof is not authentication/access control; `context`: Key proof сам по себе недостаточен.
...
- **evidence / locator / relation / reasoning:** [P07-S042](Источники.md#p07-s042) / `P07-S042-20260915`; Governing Council; `supports`: распределение ролей дано явно в политике проекта.
