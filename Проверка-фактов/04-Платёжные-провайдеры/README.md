...
Полностью прочитаны CHAPTER.md, CLAIMS.md и SOURCES.md. Все 44 claim ID и 24 source ID имеют отдельные строки: [CLAIM_AUDIT.md](Проверка-утверждений.md), [SOURCE_AUDIT.md](Проверка-источников.md). Все оригинальные URL самостоятельно запрошены. Содержательные нужные фрагменты получены у всех 24 источников; при 403/оболочке использован web original, а для Stripe дополнительно его официальный Markdown, что отдельно отражено в матрице. Это не означает полного чтения каждого большого rulebook.
...
|---|---|
| [chapters/part-04/CHAPTER.md](../../Учебник/04-Платёжные-провайдеры/README.md) | `820c833732c1e70d7dfdeea1b21dab5835291fbadb631aca06d6ecdf93d90407` |
| [chapters/part-04/SOURCES.md](../../Учебник/04-Платёжные-провайдеры/Источники.md) | `adaca25348b531b671891072ad3be75d89f9b7bd8f650ea32293c39db3ac2c03` |
| [chapters/part-04/CLAIMS.md](../../Учебник/04-Платёжные-провайдеры/Утверждения.md) | `e75ef4d8a87cc17a2715f58c1b564fd09d7ef8f76c35f78ccde3376f8b1f3664` |
