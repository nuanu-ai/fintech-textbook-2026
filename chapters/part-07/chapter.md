---
title: "Часть 7. Agentic / machine payments и протоколы"
date: "2026-09-17"
status: "draft"
visibility: "public"
...
Предварительные знания: [часть 2](../part-02/chapter.md), особенно authorization / settlement; [части 3–5](../part-03/chapter.md) о схемах, PSP и кошельках. Blockchain finality и конвертация подробно разобраны в [части 6](../part-06/chapter.md). Здесь рассматривается надстройка делегированной покупки. Все денежные примеры синтетические; они не описывают тарифы, результаты или запуск продукта Lab.
...
Глава дает модель чтения протоколов и проектирования контролей. Для интеграции необходимы [часть 8](../part-08/chapter.md) о ledger, idempotency и операционном восстановлении и сквозные кейсы части 9, запланированной в [структуре базы](../../structure.md). Публикация документации, действующий endpoint или найденный каталог не заменяют проверку полного пути конкретного продукта.
