---
title: "Часть 1. Право, географии и ответственность в платежах"
date: "2026-09-17"
status: "draft"
visibility: "public"
...
# Часть 1. Право, географии и ответственность в платежах
...
После чтения читатель сможет: различать продавца, технического подрядчика и регулируемого поставщика услуги; нарисовать деньги отдельно от договоров; объяснить ограничения партнерской модели в шести географиях; составить проверяемую карту AML, данных и претензий. Предварительно: [деньги, обязательства и учет — часть 0](../part-00/chapter.md). Правила карточек доказательств: [SOURCES](sources.md), существенные тезисы: [CLAIMS](claims.md).
...
Рабочая карта платежного продукта соединяет четыре вида evidence: разрешение на конкретную деятельность; договорное распределение обязанностей; фактические деньги/данные; исполненный результат для клиента. Ни один документ по отдельности не заменяет остальные. Для повторения механики вернитесь к [части 2: платежная транзакция](../part-02/chapter.md); далее по учебному маршруту — [часть 3](../part-03/chapter.md) и [часть 4](../part-04/chapter.md). Custody/stablecoin детали — [часть 5](../part-05/chapter.md) и [часть 6](../part-06/chapter.md). Открытые юридические пункты и неполный доступ сохранены в [CLAIMS](claims.md) и [SOURCES](sources.md); результат независимого review находится в REVIEW.md (исторический или служебный материал; сохранен у владельца, вне этой копии).
